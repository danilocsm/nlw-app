    ...
    <>
      ...
      <div className="flex flex-col items-center py-10 w-[304px]">
        ...
        <button
          ...
          className="py-2 px-6 mt-6 bg-blue-400 dark:bg-zinc-800 rounded-md border-transparent text-sm leading-6 dark:hover:bg-zinc-700 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-blue-400 focus:ring-blue-400 dark:focus:ring-offset-zinc-900 dark:focus:ring-brand-500"
        >
          Quero enviar outro
        </button>
      </div>
